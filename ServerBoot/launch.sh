...
#aws s3 cp project1b.war s3://${S3_BUCKET}/project1b.war, NOT NEEDED done in install-my-app.sh already
aws ec2 run-instances --image-id ${AMI} --count $(NUM_INSTANCES) --instance-type t2.micro --user-data install-my-app.sh
